...
// 'kubejs:golden_age'是种类的id，"golden_age.tooltips.dlc_template_template"是本地化键名，'#ffffff'是游戏内显示的颜色
global.DLC_TEMPLATE_TYPE_MAP = {
    'kubejs:golden_age': Text.of({ "translate": "golden_age.tooltips.golden_age" }).color('#ffffff'),
}
