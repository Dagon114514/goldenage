...
const dlcTemplateEntityLootStrategies = {
    // 示例器官-实体战利品
    'golden_age:example_organ_loot_entity': function (event, organ) {
        // 向掉落中加入一根木棍
...
const dlcTemplateEntityLootOnlyStrategies = {
    // 示例器官-唯一实体战利品
    'golden_age:example_organ_loot_entity_only': function (event, organ) {
        // 在被杀实体的位置生成爆炸
...
const dlcTemplateChestLootStrategies = {
    // 示例器官-箱子战利品
    'golden_age:example_organ_loot_chest': function (event, organ) {
        // 获取玩家
...
const dlcTemplateChestLootOnlyStrategies = {
    // 示例器官-唯一箱子战利品
    'golden_age:example_organ_loot_chest_only': function (event, organ) {
        // 添加随机数量的钻石
